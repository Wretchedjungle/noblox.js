const { addUsersToConversation, chatSettings, getChatMessages, getConversations, getRolloutSettings, getUnreadConversationCount, getUnreadMessages, getUserConversations, markChatAsRead, markChatAsSeen, multiGetLatestMessages, onNewConversation, onNewMessage, onNewMessagebySelf, onUserOnline, onUserTyping, removeFromGroupConversation, renameGroupConversation, sendChatMessage, setChatUserTyping, start121Conversation, startCloudEditConversation, startGroupConversation, setCookie } = require('../lib')
...
describe('Chat Methods', () => {
  ...
  it('removeFromGroupConversation() removes a user from a given conversation', () => {
    return addUsersToConversation(newConversationId, [66592931])
  })
